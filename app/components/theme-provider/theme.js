...
const baseTokens = {
  ...
  hindiFontStack: 'Rajdhani, Noto Sans Devanagari, Mukta, Poppins, Segoe UI, sans-serif',
...
const dark = {
  gold: 'rgba(183, 143, 70, 1)',
  background: 'oklch(17.76% 0 0)',
  backgroundLight: 'oklch(21.78% 0 0)',
  primary: 'linear-gradient(90deg,var(--gold) 0%, rgba(242, 230, 150, 1) 100%)',
  // primary: 'oklch(0.4184 0.168968 23.2531)',
  accent: 'linear-gradient(90deg,var(--gold) 0%, rgba(242, 230, 150, 1) 100%)',
  glow: 'var(--gold)',
...
const light = {
  gold: 'rgba(150, 110, 40, 1)',
  background: 'oklch(96.12% 0 0)',
  backgroundLight: 'var(--white)',
  primary: 'var(--black)',
  accent: 'linear-gradient(90deg, var(--gold) 0%, rgba(240, 200, 80, 1) 100%)',
  glow: 'var(--black)',
